...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  /**
   * Caso o dado passado, vindo da api,  não esteja carregado em cache, 
   * se o fallback estiver "true", ele procura a informação na api para add
   * a página em cache e carrega-la no browser.
   */
}
